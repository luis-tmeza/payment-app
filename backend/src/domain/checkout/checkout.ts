...
export type CheckoutCommand = { checkoutKey: string; items: CheckoutLine[]; customer: CheckoutCustomer; delivery: CheckoutDelivery; card: CheckoutCard; acceptedTerms: boolean; acceptedPersonalData: boolean; clientIp?: string; };
